...
<head>
  ...
  <title><?php echo $title['identitas_nama'];?> | Faq Question</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add Pertanyaan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  <td><?php echo $no;?></td>
                  <td><?php echo $tanya;?></td>
                  <td><?php echo $jawab;?></td>
                  <?php if($stat=='1'):?>
                    <td>Left</td>
                  <?php else:?>
                    <td>Right</td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Pertnyaan</label>
                          <div class="col-sm-7">
                              <input type="text" name="xtanya" class="form-control" id="inputUserName" placeholder="Pertanyaan" required>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Jawaban</label>
                          <div class="col-sm-7">
                            <textarea class="form-control" name="xjawab" rows="5" placeholder="Jawaban ..."></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Posisi</label>
                          <div class="col-sm-7">
                            <select class="form-control" name="xstat" required>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Pertanyaan</label>
                          <div class="col-sm-7">
                            <input type="hidden" name="xtanya" value="<?php echo $id;?>" class="form-control">
                            <textarea class="form-control" name="xjawab" rows="3" placeholder="Pertnyaan ..."><?php echo $tanya;?></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Jawaban</label>
                          <div class="col-sm-7">
                            <textarea class="form-control" name="xjawab" rows="6" placeholder="Jawaban ..."><?php echo $jawab;?></textarea>
                          </div>
                      </div>
                      <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Posisi</label>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              ...
              <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                            <p>Apakah Anda yakin mau menghapus Faq <b><?php echo $tanya;?></b> ?</p>
