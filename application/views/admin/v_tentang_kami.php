...
<head>
  ...
  <title><?php echo $title['identitas_nama'];?> | Tentang Kami</title>
 ...
 <?php
  ...
  <div class="content-wrapper">
    ...
    <?php
      $b=$data->row_array();
    ?>
		  <form action="<?php echo base_url().'admin/seting/edit_tentang'?>" method="post" enctype="multipart/form-data">

        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="text" name="xjudul" value="<?php echo $b['identitas_moto'];?>" class="form-control" placeholder="Judul" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-danger">
			...
			<textarea id="ckeditor" name="xtentang" required><?php echo $b['identitas_tentang'];?></textarea>
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <!-- <div class="form-group">
                <input type="text" name="xdrive" class="form-control" placeholder="Link Download" required/>
              </div> -->
			        <div class="form-group">
                <label>Gambar</label>
