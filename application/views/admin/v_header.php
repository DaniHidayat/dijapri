    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" title="Lihat Komentar" data-toggle="dropdown">
              <i class="fa fa-bell"></i>
              <span class="label label-success"><?php echo $jum_pesan;?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">Anda memiliki <?php echo $jum_pesan;?> Komentar</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                <?php
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <?php if ($this->session->userdata('level')=='1') { ?>
                ...
                <div class="pull-left">
                  <a href="<?php echo base_url().'admin/seting/profil'?>" class="btn btn-default btn-flat"><i class="fa fa-user"> Profil</i></a>
                </div>
                <?php }else { ?>
                <div class="pull-right">
                  <a href="<?php echo base_url().'admin/login/logout'?>" class="btn btn-default btn-flat"><i class="fa fa-sign-out">Sign out</i></a>
