                ...
                <?php foreach ($populer->result() as $row) :?>
                  ...
                  <div class="recent-single-post">
                    ...
                    <div class="pst-content">
                      <p><strong><a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>"><?php echo limit_words($row->tulisan_judul,3).'...';?></a></strong></p>
              ...
              <article class="blog-post-wrapper">
                ...
                <div class="post-information">
                  ...
                  <div class="entry-content">
                    <p><?php echo $blog;?></p>
                    <?php if ($link_driv) {
                        echo '<blockquote><p>Silahkan Download Sourcode Di Sini.</p>
