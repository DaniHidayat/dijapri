        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-12 col-lg-7">
                    ...
                    <form action="<?php echo base_url('admin/user/simpan_registrasiUser');?>" method="POST">
                        <h5>Daftar Akun</h5>
                                <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select class="custom-select d-block w-100" id="kota" name="kota">
                                ...
                                <p><strong>Login? </strong> <span><small><a href="<?php echo base_url('admin/user');?>"> Login</a></small></span></p>
                                </div>
                            <div class="col-md-3 mb-4">
                            <button type="submit" class="btn alazea-btn w-100">Daftar</button>
                        </div>
                        </div>
                        </form>
                    </div>
...
//ambil id/nilai PROVINSI dan kirim ke function getkota jika sukses ambil data getkota letakan di #kota dan #kota1
  $("#provinsi").change(function(){
    ...
    var url = '<?=site_url();?>/admin/user/getKota/'+key;


    $.ajax({
      type    : 'POST',
      url     : '<?=site_url();?>/admin/user/getKota/'+key,
      success : function(){
